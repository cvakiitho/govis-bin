...
RUN cd /etc/ssl/certs/ \
 && wget "http://aia.pki.co.sap.com/aia/SAP%20Global%20Root%20CA.crt" -O SAP_Global_Root_CA.crt \
 ...
 && wget "http://aia.pki.co.sap.com/aia/SAP%20Global%20Sub%20CA%2004.crt" -O SAP_Global_Sub_CA_04.crt \
 ...
 && wget "http://aia.pki.co.sap.com/aia/SAPNetCA_G2.crt" -O SAPNetCA_G2.crt \
